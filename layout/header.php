...
<body>
    <div class="flex">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="text-dark btn-lg" href="menu.php"><i class="fas fa-home"></i></a>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="carteMOY.php">Region</a>
                            <a class="dropdown-item" href="carteDepMOY.php">Departement</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="listeDep.php">Liste des Departements</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
