...
$r = $db->prepare("select departement.NCC, departement.POP, departement.DEP, SUM(donnees_gaz.CONSOR) as \"donnees_gaz\" from donnees_gaz
                                join departement on departement.Dep = donnees_gaz.Dep
                                GROUP BY departement.NCC
                                ORDER BY SUM(donnees_gaz.CONSOR)");
$r->execute();
$results_gaz = $r->fetchAll();


$r = $db->prepare(" select departement.NCC, departement.POP,departement.DEP,SUM(donnees_elec.CONSOR) as \"donnees_elec\" from donnees_elec
...
$r = $db->prepare(" select departement.NCC, departement.POP,departement.DEP, SUM(donnees_petrole.SUPER_SANS_PLOMB) as \"donnees_ssp\" from donnees_petrole
...
$r = $db->prepare(" select departement.NCC, departement.POP,departement.DEP, SUM(donnees_petrole.GAZOLE) as \"donnees_gazol\" from donnees_petrole
                                join departement on departement.Dep = donnees_petrole.Dep
                                join region on region.region = departement.region
                                GROUP BY departement.NCC
    ...
    <main class="container">
        ...
        <table class="table">
            ...
            foreach ($results_elec as $index => $lign) {
                ...
                $stats_elec[$index]["Region"] = $lign["DEP"];
    ...
    <main class="container">
        ...
        <table class="table">
            ...
            foreach ($results_gaz as $index => $lign) {
                ...
                $stats_gaz[$index]["Region"] = $lign["DEP"];
            }
    ...
    <main class="container">
        ...
        <table class="table">
            ...
            foreach ($results_ssp as $index => $lign) {
                ...
                $stats_ssp[$index]["Region"] = $lign["DEP"];
            }
    ...
    <main class="container">
        ...
        <table class="table">
            ...
            foreach ($results_gazol as $index => $lign) {
                ...
                $stats_gazol[$index]["Region"] = $lign["DEP"];
            }
